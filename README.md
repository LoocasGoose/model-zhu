...
CUDA_VISIBLE_DEVICES=1 python main.py --cfg configs/densenet.yaml --data_path /honey/nmep/medium-imagenet-96.hdf5 --batch_size 32 --attention cbam --activation mish --epochs 50

python main.py --cfg configs/densenet.yaml --opts data_path /custom/path/dataset.hdf5 batch_size 32 model_type 169 attention cbam activation mish epochs 50
